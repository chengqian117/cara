...
public class EccTest {
    ...
    public void RootTest(){
        ...
        try{
            ...
            EccUtils.generateAndExportRoot(alias,password,subject,"root");
    ...
    public void CaUtilsTest(){
        ...
        try {
            ...
            Certificate c1 = ks.getCertificate(root);
...
//            }
    ...
    public void CaUtilsTest3(){
        ...
        try {
            ...
            KeyStore ks = KeyStore.getInstance("jks");
            ks.load(in, password.toCharArray());
            Certificate c1 = ks.getCertificate("b1");
            X509CertImpl rootCer = new X509CertImpl(c1.getEncoded());
            X509CertInfo rooCerInfo = (X509CertInfo) rootCer.get(X509CertImpl.NAME +
                    "." + X509CertImpl.INFO);
...
// 签名
    ...
    public void test2(){
        try {
            ...
            Certificate c1 = ks.getCertificate("server1");
//        (2)获得CA的私钥：
...
//            System.out.println(adas);
            ...
            final String commonName = "www.dspread.net";
            final String organizationalUnit = "www.dspread.net";
            final String organization = "www.dspread.net";
            final String city = "shenzhen";
            final String state = "guangdong";
            final String country = "CN";
            X500Name subject = new X500Name(commonName, organizationalUnit, organization, city, state, country);
